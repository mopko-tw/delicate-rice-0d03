...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/delicate-rice-0d03)
...
3. Create a [D1 database](https://developers.cloudflare.com/d1/get-started/) with the name "lingering-smoke-4057-d1":

```bash
npx wrangler d1 create lingering-smoke-4057-d1
```
